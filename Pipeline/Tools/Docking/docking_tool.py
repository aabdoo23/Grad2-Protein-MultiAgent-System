...
class DockingTool:
    def __init__(self):
        ...
        self.vina_executable = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 
                                          "Tools","Docking","Util","vina.exe")
        # Set up static directory for results
